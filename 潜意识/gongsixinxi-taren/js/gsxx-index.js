	$(function(){
		...
		for (var i = 0; i < hx_tagbox.length-1; i++) {
			hx_tagbox[i].index=i;
			hx_tagbox[i].onclick=function(){
				...
				this.style.background="#e8bc0f";
				this.style.width=148+"px";
				this.style.height=76+"px";
				this.style.marginTop=0;
				this.style.border="2px solid #fff";
				this.style.lineHeight=66+"px";
				hx_box1[this.index].style.display="block";
				hx_underline[this.index].style.display="block";
